                                    ...
                                    <div class="table-wrap table-responsive">
                                        ...
                                        @foreach($category as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <x-delete-popover :url="route('admin.ads.category.delete',$data->id)"/>
                                                    <a href="#"
                                                       data-toggle="modal"
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.ads.category')}}" method="post" enctype="multipart/form-data">
                            @csrf
        ...
        $(document).ready(function () {
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.ads.category.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds
                        },
