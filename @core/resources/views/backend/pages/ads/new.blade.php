                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title">{{__('Add New ads Post')}}</h4>
                            <a href="{{route('admin.ads')}}" class="btn btn-primary">{{__('All Ads')}}</a>
                        </div>

                        <form action="{{route('admin.ads.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="ads_content" >
...
@section('script')
    ...
    <x-backend.auto-slug-js :url="route('admin.ads.slug.check')" :type="'new'"/>
    <script>
