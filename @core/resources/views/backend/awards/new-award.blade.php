                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title">{{__('Add New award  Post')}}</h4>
                            <a href="{{route('admin.awards.all')}}" class="btn btn-primary">{{__('All awards')}}</a>
                        </div>
                        <form action="{{route('admin.awards.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="award_context" >
                                        <div class="summernote" ></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="award_responsibility">{{__('award Responsibility')}}</label>
                                        <input type="hidden" name="award_responsibility" >
                                        <div class="summernote" ></div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="award_location" name="award_location" value="{{old('award_location')}}" placeholder="{{__('award Location')}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">{{__('Add New award ')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
@section('script')
    ...
    <x-backend.auto-slug-js :url="route('admin.awards.slug.check')" :type="'new'"/>
