<div class="course-single-grid-item">
    <div class="thumb">
        ...
        <div class="cat">
            <a class="bg-{{$increment ?? ''}}" href="{{route('frontend.course.category',[Str::slug(optional(optional($course->category)->lang_front)->title,'-',optional(optional($course->category)->lang_front)->lang),$course->category->id])}}">{{optional(optional($course->category)->lang_front)->title}}</a>
        </div>
    </div>
    <div class="content">
