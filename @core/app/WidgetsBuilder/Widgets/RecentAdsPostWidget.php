...
class RecentAdsPostWidget extends WidgetBase
{
    ...
    public function frontend_render()
    {
        ...
        $ads_posts = Ads::where(['status' => 'publish','lang' => LanguageHelper::user_lang_slug()])->get();
        if (!empty($post_items)){
        ...
        foreach ($ads_posts as $post) {
            $output .= '<li class="single-recent-post-item">
                    ...
                    <div class="content">
                        <h4 class="title"><a href="' . route('frontend.ads.single',['slug' => $post->slug ]) . '">' . purify_html($post->title) . '</a></h4>
